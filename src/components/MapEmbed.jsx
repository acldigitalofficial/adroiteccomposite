export default function MapEmbed() {
  return (
    <section className="map-section" data-aos="fade-up" data-aos-duration="700">
      <div className="map-section__header" data-aos="fade-up" data-aos-delay="100" data-aos-duration="600">
        <span className="map-section__subtitle">Our Location</span>
        <h3 className="map-section__title">Sidco Industrial Estate, Alathur</h3>
      </div>
      <div className="map-section__wrapper" data-aos="fade-up" data-aos-delay="200" data-aos-duration="700">
        <iframe
